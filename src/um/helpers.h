...
#define FADED_RED(fmt, ...) Helpers::FadedPrint(255, 255, 0, 0, -5, 0, fmt, ##__VA_ARGS__)
#define FADED_GREEN(fmt, ...) Helpers::FadedPrint(255, 0, 255, -4, 8, -4, fmt, ##__VA_ARGS__)
